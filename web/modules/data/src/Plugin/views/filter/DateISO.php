...
namespace Drupal\data\Plugin\views\filter;
 ...
 *
 * @ViewsFilter("date_iso")
 */
class DateISO extends Date implements ContainerFactoryPluginInterface {
  ...
  protected function opBetween($field) {
    $origin = ($this->value['type'] == 'offset') ? (\Drupal::time()->getRequestTime()) : 0;
