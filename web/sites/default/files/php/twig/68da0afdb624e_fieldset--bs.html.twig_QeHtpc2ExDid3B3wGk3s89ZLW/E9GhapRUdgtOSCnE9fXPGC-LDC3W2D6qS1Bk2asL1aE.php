...
class __TwigTemplate_d19a066d5ee15f079bcd07d8681c433b extends Template
{
...
($context["required"] ?? null)) ? ("form-required") : (""))];
        ...
        // line 40
        yield "  <legend";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["legend"] ?? null), "attributes", [], "any", false, false, true, 40), "html", null, true);
        yield ">
    <span";
        // line 41
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["legend_span"] ?? null), "attributes", [], "any", false, false, true, 41), "addClass", [($context["legend_span_classes"] ?? null)], "method", false, false, true, 41), "html", null, true);
        yield ">";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["legend"] ?? null), "title", [], "any", false, false, true, 41), "html", null, true);
        yield "</span>
  </legend>
...
";
    ...
    {
        return new Source("", "modules/contrib/bootstrap_styles/templates/form/fieldset--bs.html.twig", "/home/website1/public_html/web/modules/contrib/bootstrap_styles/templates/form/fieldset--bs.html.twig");
    }
